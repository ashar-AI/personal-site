...
const BentoGithubActivity = (props: Props) => {
  ...
  const lastPushedDate = props.lastPushedAt ? new Date(props.lastPushedAt) : new Date()
    ...
    <div className='relative flex h-full flex-col justify-between px-4 pb-5 pt-4 max-md:gap-4'>
      ...
      <div className='w-full overflow-x-scroll'>
        {props.contributions?.length > 0 ? (
          ...
          <div className='flex h-[120px] w-full items-center justify-center text-sm text-zinc-400'>
